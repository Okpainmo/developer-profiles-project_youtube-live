      ...
      <div class="card">
                    ...
                    <div class="avatar-section flex justify-between">
                        ...
                        <div class="flex gap-6 items-center">
                            ...
                            <div class="delete-profile-icon">
                                <img src="./assets/images/delete-icon.png" class="w-[25px] cursor-pointer"
                ...
                <section class="contacts-section">
                    <div class="flex gap-4">
                        ...
                        <a href="mailto:${email}"
                            class="font-bold text-blue-900 hover:text-blue-500 hover:underline">${email}</a>
                    </div>
                    <div class="flex gap-4 mt-4">
                        ...
                        <a href="${website}"
                            class="font-bold text-blue-900 hover:text-blue-500 hover:underline">${website}</a>
                    </div>
                </section>
            </div>
        `;
